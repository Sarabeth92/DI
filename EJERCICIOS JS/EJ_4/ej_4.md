...
```js
//Enunciado: Descarga los posts y quédate solo con los de userId = 1.
//Devuelve un array de títulos en mayúsculas.
...
```js
//Enunciado: Descarga los productos de Fake Store API y calcula el precio total
//de los productos con category = 'electronics'.
...
```js
//Enunciado: Descarga usuarios y posts en paralelo. Devuelve una lista de objetos
//{ userName, postsCount }, ordenada descendentemente por postsCount.
...
```js
//Enunciado: De JSONPlaceholder, toma comments, filtra los que contengan la palabra 'qui' en body,
//normaliza email a minúsculas, y ordénalos por postId asc y después por email asc.
